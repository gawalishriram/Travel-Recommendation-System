...
<body>
			...
			<div class="collapse navbar-collapse" id="menu">
				...
				<ul class="navbar-nav ms-auto align-items-center">
					...
					<li class="nav-item"><a class="nav-link"
						href="destination.jsp"> Destinations </a></li>
 ...
 -->
					...
					<li class="nav-item"><a class="nav-link" href="adminLogin.jsp">
							Admin</a></li>
					...
					<li><a href="login.jsp"
						class="btn btn-outline-primary btn-login"> Login </a></li>



					<li><a href="register.jsp"
						class="btn btn-primary btn-register"> Register </a></li>
				...
				<div class="col-lg-7">
					...
					<div class="hero-content">
						...
						<div class="hero-btn">
							...
							<a href="recommendation.jsp" class="btn btn-warning btn-lg">
					...
					<div class="card border-0 shadow-lg overflow-hidden">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between">
								...
								<strong> ₹18,000 </strong> <a href="destinationDetails.jsp"
									class="btn btn-primary rounded-pill"> Explore </a>
					...
					<div class="card border-0 shadow-lg overflow-hidden">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between">
								...
								<strong> ₹25,000 </strong> <a href="destinationDetails.jsp"
									class="btn btn-primary rounded-pill"> Explore </a>
					...
					<div class="card border-0 shadow-lg overflow-hidden">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between">
								...
								<strong> ₹22,000 </strong> <a href="destinationDetails.jsp"
									class="btn btn-primary rounded-pill"> Explore </a>
					...
					<div class="card border-0 shadow-lg overflow-hidden">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between">
								...
								<strong> ₹35,000 </strong> <a href="destinationDetails.jsp"
									class="btn btn-primary rounded-pill"> Explore </a>
					...
					<div class="card border-0 shadow-lg overflow-hidden">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between">
								...
								<strong> ₹40,000 </strong> <a href="destinationDetails.jsp"
									class="btn btn-primary rounded-pill"> Explore </a>
					...
					<div class="card border-0 shadow-lg overflow-hidden">
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between">
								...
								<strong> ₹20,000 </strong> <a href="destinationDetails.jsp"
									class="btn btn-primary rounded-pill"> Explore </a>
				...
				<div class="col-lg-4">
					...
					<div class="card border-0 shadow h-100">
						...
						<div class="card-body p-4">
							...
							<a href="booking.jsp" class="btn btn-primary rounded-pill w-100">
