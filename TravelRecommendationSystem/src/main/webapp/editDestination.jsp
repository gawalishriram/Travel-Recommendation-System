...
<head>
    ...
    <title>Edit Destination | TravelAI Admin</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="container-fluid px-3 px-md-4 py-4">
            ...
            <div
                ...
                class="destination-form-card d-none">
    ...
    <script
        src="${pageContext.request.contextPath}/js/editDestination.js">
    </script>
